...
<div class="wrapper wrapper-content">
	<div class="row">
				...
				<div class="mail-box-header">
					<div class="layui-form-item">
						<div class="layui-input-group">
							...
							<input type="text" name="title" style="width: 800px;border-color: #ff9900;" placeholder="输入名称" class="layui-input">
						</div>
					</div>
					...
					<div class="mail-body text-right tooltip-demo">
						...
						<button type="button" onclick="javascript:window.location.href='../../auto/config/table.jsp'"
		...
		<script type="module" src="/static/js/admin/auto/config/update.js"></script>
