			...
			<div class="ibox float-e-margins">
				<div class="mail-box-header">
					...
					<form class="layui-form layui-form-pane" style="padding:10px;" action="xxx">
						<div class="layui-form-item">
							...
							<div class="layui-input-inline layui-input-wrap">
								<input type="text" name="small_title" lay-verify="required" placeholder="小标题" autocomplete="off" lay-affix="clear" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label">描述：</label>
							<div class="layui-input-block">
								<input type="text" name="introduction" autocomplete="off" placeholder="描述" lay-verify="required" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label">按钮链接：</label>
							<div class="layui-input-inline layui-input-wrap">
								<input type="text" name="button_link" lay-verify="required" placeholder="按钮链接" autocomplete="off" lay-affix="clear" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label">按钮信息：</label>
							<div class="layui-input-inline layui-input-wrap">
								<input type="text" name="button_info" lay-verify="required" placeholder="按钮信息" autocomplete="off" lay-affix="clear" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
					...
					<div class="mail-body text-right tooltip-demo">
						...
						<button type="button" onclick="javascript:window.location.href='../recommend/table.jsp'"
...
<script type="module" src="/static/js/admin/recommend/update.js"></script>
</body>
</html>
