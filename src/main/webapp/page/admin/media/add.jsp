...
<div class="wrapper wrapper-content">
		...
		<div class="col-sm-9">
			<div class="ibox float-e-margins">
				...
				<div class="mail-body text-right tooltip-demo">
					<button id="deault_submit" type="button" class="btn btn-sm btn-primary" data-placement="top" title="发表" data-toggle="tooltip">
						<i class="fa"></i> 默认发表
					</button>
	...
	<script type="module" src="/static/js/admin/media/add.js"></script>
</body>
</html>
