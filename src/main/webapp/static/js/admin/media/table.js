...
$(document).ready(function(){
    layui.use(['table', 'dropdown'], function(){
        ...
        table.render({
            elem: '#test'
            ,url:'/admin/media/table' // 此处为静态模拟数据，实际使用时需换成真实接口
            ,toolbar: '#toolbarDemo'
            ,headers: {
                ...
                ,{
                    field: 'status', title: '状态', align: 'center',width: 170, templet: function (d) {
                        ...
                        if (d.status == '0') {
                            ...
                            str = str + '<span style="background-color: #cccccc" class="layui-badge">草稿</span>'
                        }
                        return str;
                    }
                }
                    ...
                    ,click: function(obj){
                        ...
                        switch(obj.id){
                            ...
                            case 'DRAFT':
                                ...
                                updateStatus(selectedIds,2,"移到草稿")
                                break;
                            case 'PUBLISHED':
                                var selectedIds = data.map(function(item) {
                                    return item.id;
        ...
        table.on('tool(test)', function(obj){ // 双击 toolDouble
            ...
            // console.log(obj)
            if(obj.event === 'edit'){
                window.location.href = "/page/admin/media/update.jsp?id="+data.id;
