...
<article>
    <div class="lbox">
       <div class="infos">
            <div class="newsview">
                <div class="intitle">
                    <a href="/">帮忙么</a>&nbsp;&gt;&nbsp;<a href="/softDetail/${blog.soft.id}.html" rel="nofollow">${blog.soft.title}</a>&nbsp;&gt;&nbsp;当前页面
                        </div>
        ...
        <div style="margin:3px 0px 3px 0px;" class="nextinfo">
             <p>
                上一篇：<span class="prev"><c:if test="${prev != null}"><a href="/find/${prev.id}.html" rel="bookmark">${prev.title}</a></c:if><c:if test="${prev == null}">无</c:if></span>
            </p>
            <p>
                下一篇：<span class="next"><c:if test="${next != null}"> <a href="/find/${next.id}.html" rel="bookmark">${next.title}</a> </c:if> <c:if test="${next == null}"> 无</c:if></span>
            </p>
       </div>
