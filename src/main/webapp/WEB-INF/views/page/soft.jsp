...
<article>
        ...
        <div class="newblogs bloglist">
            <ul>
                <c:forEach var="item" items="${softList}" varStatus="status">
                    <li>
                        <h3 class="blogtitle">
                            <a style="color:#467ab2;"  href="<%= basePath %>/softDetail/${item.id}/1.html">${item.title}</a>
                        </h3>
                        <span class="blogpic">
    ...
    <div class="rbox">
        ...
        <div style="margin-top:10px;" class="cloud whitebg">
            ...
            <ul>
                <a href="<%= basePath %>/softInfo/79.html">看新闻</a>
                <a href="<%= basePath %>/softInfo/78.html">看视频</a>
                <a href="<%= basePath %>/softInfo/77.html">做任务</a>
                <a href="<%= basePath %>/softInfo/85.html">短视频</a>
                <a href="<%= basePath %>/softInfo/86.html">试玩赚</a>
                <a href="<%= basePath %>/softInfo/83.html">自媒体</a>
                <a href="<%= basePath %>/softInfo/84.html">建网站</a>
                <a href="<%= basePath %>/softInfo/88.html">看小说</a>
                <a href="<%= basePath %>/softInfo/82.html">玩游戏</a>
                <a href="<%= basePath %>/softInfo/80.html">淘宝客</a>
            </ul>
        </div>
    </div>
</article>
