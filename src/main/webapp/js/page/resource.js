            ...
            success:function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                	...
                	if(i==1){
                		...
                		likeBlog_2+='<li style="animation-delay:'+time+'s" class="animated fadeInDown"> <i><img src="'+data[i].images+'"></i><p><a href="find/'+id+'.html">'+data[i].title+'</a></p><span>'+Format(data[i].createTime,"yyyy-MM-dd")+'</span> </li>';
